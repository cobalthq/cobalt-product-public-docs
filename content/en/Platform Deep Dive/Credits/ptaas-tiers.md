...
| SAML-based SSO | ✓ | ✓ | ✓ | An Organization Owner can configure [SAML-based SSO](/getting-started/sign-in/#saml-sso) for their organization to enhance the security of the sign-in process. |
