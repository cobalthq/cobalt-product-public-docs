...
<div class="col-md-6">
        <div class="h-100 p-5 border rounded-lg card" style="border-color: rgba(255, 255, 255, 0)">
                <img src="/homepage/dast.svg" alt="DAST" style="float: left; margin-right: 10px;">
      ...
      <div class="col-md-6">
        <div class="h-100 p-5 border rounded-lg card" style="border-color: rgba(255, 255, 255, 0)">
                          <img src="/homepage/engagements.svg" alt="Engagements" style="float: left; margin-right: 10px;">
