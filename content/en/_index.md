...
<div class="row g-4 my-3 px-5 row-cols-1 row-cols-lg-3">
     ...
     <div class="feature col">
       ...
       <h4><a href="/pentests/createpentest/overview/#3-set-the-test-focus" class="custom-link-color"><b>Pentest Types</b></a></h4>
...
<h3><b class="gradient-text">Try Our DAST Scanner</b></h3>
        ...
        <a class="btn btn-outline-primary rounded" href="/platform-deep-dive/scans/">Learn More »</a>
      </div>
    </div>
  </div>
  <div class="col-md-6">
