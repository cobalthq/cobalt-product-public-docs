...
<div class="col-md-6">
        <div class="h-100 p-5 border rounded-lg card" style="border-color: rgba(255, 255, 255, 0)">
                <img src="/homepage/dast.png" alt="DAST" style="float: left; margin-right: 10px;">
      ...
      <div class="col-md-6">
        <div class="h-100 p-5 border rounded-lg card" style="border-color: rgba(255, 255, 255, 0)">
                          <img src="/homepage/engagements.png" alt="Engagements" style="float: left; margin-right: 10px;">
