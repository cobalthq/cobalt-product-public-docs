...
- To **edit** a webhook, select the three-dot icon ![Three-dot icon](/icons/Ellipsis.png "Three-dot icon") under **Actions**, and then select **Edit Webhook**. Update webhook parameters in the overlay that appears.
- To **delete** a webhook, select the three-dot icon ![Three-dot icon](/icons/Ellipsis.png "Three-dot icon") under **Actions**, and then select **Delete Webhook**.
