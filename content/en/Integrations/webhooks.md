...
| Pentest | Finding |
|---|---|
| <li>Pentest created</li><li>[Pentest state](/penteststates/) changed</li> | <li>Finding created</li><li>Finding state changed</li><li>Finding updated</li><li>Finding deleted</li>
